...
*Permet d'obtenir votre token d'authentification à l'API Flatsy*
...
```shell
# You can also use wget
curl -X GET /www.flatsy.fr/api/v1/business/visit/slots?propertyId=string \
  -H 'Accept: */*' \
  -H 'X-Auth-Token: API_KEY'
...
```http
GET /www.flatsy.fr/api/v1/business/visit/slots?propertyId=string HTTP/1.1
...
$.ajax({
  url: 'https://wwww.flatsy.fr/api/v1/business/visit/slots',
  method: 'get',
...
fetch('https://wwww.flatsy.fr/api/v1/business/visit/slots?propertyId=string',
{
  method: 'GET',
...
result = RestClient.get 'https://wwww.flatsy.fr/api/v1/business/visit/slots',
  params: {
...
r = requests.get('https://wwww.flatsy.fr/api/v1/business/visit/slots', params={
  'propertyId': 'string'
}, headers = headers)
...
```java
URL obj = new URL("/www.flatsy.fr/api/v1/business/visit/slots?propertyId=string");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
func main() {
    ...
    data := bytes.NewBuffer([]byte{jsonReq})
    req, err := http.NewRequest("GET", "/www.flatsy.fr/api/v1/business/visit/slots", data)
    req.Header = headers
